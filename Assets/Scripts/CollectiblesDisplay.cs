...
public class CollectiblesDisplay : MonoBehaviour
{
    public enum CollectibleType { CrystalCoins, Diamonds }
    ...
    public void UpdateDisplay()
    {
        ...
        int amount = (_collectibleType == CollectibleType.CrystalCoins)
            ? DatabaseManager.Instance.GetTotalCoins()
            : DatabaseManager.Instance.GetTotalCollectedStarCoins();
